                    ...
                    <div class="row">
                        <div class="col-sm-5 offset-sm-2">
                            <div class="form-group">
                                ...
                                <select name="bag_id" class="form-select form-control">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="component_type" name="component_type" required>
                                    ...
                                    <option value="2">Packed Red Blood Cells (PRBC) — RBC</option>
                                    <option value="3">Fresh Frozen Plasma (FFP) — FFP</option>
                                    <option value="4">Platelets — PLT</option>
                        ...
                        <div class="col-sm-5 offset-sm-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" id="processing_date" name="processing_date" required>
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-group">
                        ...
                        <div class="col-sm-5 offset-sm-2">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="storage_location" name="storage_location" required>
                                    ...
                                    <option value="1">Refrigerator A Rack 01 Slot 01</option>
                                    <option value="2">Refrigerator A Rack 01 Slot 02</option>
                                    <option value="3">Refrigerator A Rack 01 Slot 03</option>
                                    <option value="4">Refrigerator A Rack 02 Slot 01</option>
                                    <option value="5">Refrigerator A Rack 02 Slot 02</option>
                                    <option value="6">Refrigerator A Rack 02 Slot 03</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-12">
