            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-5 col-5">
                        <h4 style="color: #104d6f; font-size: 24px;">Edit Donor Information</h4>
                    </div>
                    <div class="col-sm-7 col-7 text-right m-b-30">
                        <a href="<?= $base_url; ?>blood_bank/donor/donor.php" style="display:inline-flex;align-items:center;gap:9px;padding:9px 17px;background:#104d6f;color:#fff;border-radius:7px;text-decoration:none;font-size:14px;font-weight:600;box-shadow:0 3px 8px rgba(13,110,253,.22);">
                ...
                <div class="row">
                    <div class="col-sm-3 offset-sm-2">
                        <form action="<?= $base_url; ?>blood_bank/donor/update_donor.php?id=<?= $donor->id ?>" method="POST">
							<div class="form-group">
								<label for="donor_name">Name:</label>
								<input class="form-control" type="text" id="donor_name" name="donor_name" value="<?= $donor->donor_name ?>" required>
							</div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label for="age">Age:</label>
                            <input class="form-control" type="number" id="age" name="age" value="<?= $donor->age ?>" required>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label for="phone">Phone:</label>
                            <input class="form-control" type="number" id="phone" name="phone" value="<?= $donor->phone ?>" required>
                        </div>
                    </div>
                    <div class="col-sm-3 offset-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" id="last_donation" name="last_donation" value="<?= $donor->last_donation ?>" required>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                            <label for="address">Address:</label>
                            <input class="form-control" type="text" id="address" name="address" value="<?= $donor->address ?>" required>
                        </div>
                    </div>
                    <div class="col-sm-3 offset-sm-2">
                        <div class="form-group">
