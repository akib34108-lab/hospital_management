...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2026 at 03:13 PM
...
(6, 8, '4', 1, 1, NULL, NULL, NULL),
(7, 9, '5', 1, 1, NULL, NULL, NULL);
...
(2, 5, 16600.00, 0.00, 0.00, 16600.00, 0.00, 'Paid', NULL, '2026-08-08', 1),
(3, 2, 2208.00, 1000.00, 800.00, 0.00, 0.00, 'Due', NULL, '2026-08-09', 1),
(4, 2, 2000.00, 100.00, 95.00, 0.00, 0.00, 'Due', NULL, '2026-08-09', 1),
(5, 1, 11200.00, 525.00, 375.00, 10000.00, 1050.00, 'Partial', NULL, '2026-08-09', 1),
...
(8, 'shakib', '1', '27', 'AB+', '01887925099', 'shakib45@gmail.com', 'khulshi', 0.00, '0165888888', '2026-08-20 13:44:15', '2026-08-20 13:44:15', NULL, NULL, NULL),
(9, 'fyroz Anika', '2', '16', NULL, '01858053316', NULL, NULL, 0.00, NULL, '2026-08-22 13:02:46', '2026-08-22 13:02:46', NULL, NULL, NULL),
(10, 'azad', '1', '25', NULL, '019111111111', NULL, NULL, 0.00, NULL, '2026-08-22 13:10:42', '2026-08-22 13:10:42', NULL, NULL, NULL);
...
(1, 'ADM-0001', 1, 8, '6', 3, '2026-08-16', '22:19:00', '2026-08-19', '17:38:00', ' health problem', 1, NULL, '2026-08-19 11:39:39', NULL),
(2, 'ADM-0002', 5, 3, '6', 5, '2026-08-15', '19:46:00', '2026-08-21', '16:04:00', 'mental problem', 1, NULL, '2026-08-21 10:05:12', NULL),
(3, 'ADM-0003', 6, 10, '7', 3, '2026-08-18', '16:30:00', '2026-08-19', '15:28:00', 'health issue', 1, NULL, NULL, NULL),
(4, 'ADM-0004', 9, 3, '8', 6, '2026-08-19', '05:00:00', '2026-08-22', '15:03:00', 'Mental', 1, NULL, '2026-08-22 09:04:38', NULL),
(5, 'ADM-0005', 10, 10, '9', 7, '2026-08-20', '22:00:00', NULL, NULL, 'fgdfbfbf', 1, NULL, NULL, NULL);
...
(4, 5, 10000.00, 'bKash', '2026-08-21', '', NULL),
(5, 2, 14000.00, 'Cash', '2026-08-21', NULL, NULL),
(6, 2, 173.40, 'Cash', '2026-08-21', NULL, NULL);
...
(7, 'RM-0002', 0, 2, 1, '1', 'BED-0002', 1200.00, 1, NULL, NULL, NULL),
(8, 'RM-0003', 0, 4, 2, '2', 'BED-0004', 5000.00, 1, NULL, NULL, NULL),
(9, 'RM-0004', 0, 3, 2, '2', 'BED-0005', 3500.00, 1, NULL, NULL, NULL);
...
(0, 'Fyroz anika', 'fyrozanika001@gmail.com', '01858053316', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 1, 1, '2026-08-19 13:24:15', '2026-08-19 13:24:15', NULL);
...
--
ALTER TABLE `discharges`
  MODIFY `discharge_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `discharge_invoices`
--
ALTER TABLE `discharge_invoices`
  MODIFY `invoice_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
