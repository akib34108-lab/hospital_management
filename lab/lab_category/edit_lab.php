...
<?php require_once "../../component/sidebar.php"; 
  ...
  $id = $_GET['id'];
  $lab = $crud->common_select("lab_category", "*", ['id' => $id]);
  if (!$lab['status'] || empty($lab['data'])) {
    $_SESSION['message'] = array('danger','Error', 'Lab category not found.');
...
?>
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="<?= $base_url; ?>lab/lab_category/update_lab.php" method="POST" class="p-4">
