					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<tbody>
									<tr>
										<td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5" alt="">Azad Hossain</td>
										<td>Male</td>
										<td>25</td>
										<td>O+</td>
										<td>01887499</td>
										<td>azadkhondoker444@gmail.com</td>
										<td>Khulshi Chattrogram</td>
										<td><span>Father: </span>0187499</td>
										<td class="text-right">
