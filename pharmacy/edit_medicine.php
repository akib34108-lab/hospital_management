...
if ($medicine_id <= 0) {
    echo "<script>alert('Invalid medicine ID'); window.location.href='medicines.php';</script>";
    exit;
}

$result = $crud->common_select("medicines", "*", ["medicine_id" => $medicine_id]);

if (!$result["status"]) {
    echo "<script>alert('Medicine not found'); window.location.href='medicines.php';</script>";
    exit;
}
...
if (isset($_POST['update_medicine'])) {
    ...
    $update_result = $crud->common_update("medicines", $data, ["medicine_id" => $medicine_id]);

    if ($update_result["status"]) {
        echo "<script>alert('Medicine updated successfully'); window.location.href='medicines.php';</script>";
        exit;
    } else {
        echo "<script>alert('Error: " . $update_result["message"] . "');</script>";
    }
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><i class="fa fa-pencil"></i> Edit Medicine Information</h4>
                <p class="text-muted mb-0">Update the information of this medicine.</p>
            </div>
            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="generic_name" class="form-control" value="<?php echo htmlspecialchars($medicine->generic_name); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="brand_name" class="form-control" value="<?php echo htmlspecialchars($medicine->manufacturer); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="category" class="form-control" required>
                                    ...
                                    <option value="Antihistamine" <?php echo ($medicine->category == 'Antihistamine') ? 'selected' : ''; ?>>Antihistamine</option>
                                    <option value="Antiviral" <?php echo ($medicine->category == 'Antiviral') ? 'selected' : ''; ?>>Antiviral</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="dosage_form" class="form-control" required>
                                    ...
                                    <option value="Cream" <?php echo ($medicine->dosage_form == 'Cream') ? 'selected' : ''; ?>>Cream</option>
                                    ...
                                    <option value="Inhaler" <?php echo ($medicine->dosage_form == 'Inhaler') ? 'selected' : ''; ?>>Inhaler</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="strength" class="form-control" value="<?php echo htmlspecialchars($medicine->strength); ?>" placeholder="e.g. 500mg">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="unit_price" class="form-control" step="0.01" min="0" value="<?php echo htmlspecialchars($medicine->unit_price); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="reorder_level" class="form-control" min="0" value="<?php echo htmlspecialchars($medicine->reorder_level); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" rows="4" class="form-control" placeholder="Write medicine details..."><?php echo htmlspecialchars($medicine->description); ?></textarea>
                            </div>
                        </div>
                    ...
                    <div class="text-right">
                        ...
                        <button type="submit" name="update_medicine" class="btn btn-primary"><i class="fa fa-save"></i> Update Medicine</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-md-1 text-center">
                        <i class="fa fa-hospital-o" style="font-size:35px; color:#009efb;"></i>
                    </div>
                    <div class="col-md-8">
                        <h5>Branch Availability</h5>
                        <p class="text-muted mb-0">After updating the medicine, you can check which pharmacy branches have this medicine.</p>
                    </div>
                    <div class="col-md-3 text-right">
                        <a href="medicine_availability.php" class="btn btn-outline-info"><i class="fa fa-search"></i> Check Availability</a>
                    </div>
                </div>
            </div>
        </div>
