...
$total_medicine_result =
    $crud->conn->query($total_medicine_sql);
...
$total_branch_result =
    $crud->conn->query($total_branch_sql);
...
if ($available_medicine_result) {
    $row =
        $available_medicine_result->fetch_assoc();
...
if ($today_sales_result) {
    $row =
        $today_sales_result->fetch_assoc();
...
if ($today_sale_count_result) {
    $row =
        $today_sale_count_result->fetch_assoc();
...
$low_stock_sql = "
    ...
    INNER JOIN medicines m
        ON bm.medicine_id = m.medicine_id
    WHERE bm.quantity <= m.reorder_level
...
if ($total_stock_result) {
    $row =
        $total_stock_result->fetch_assoc();
...
$availability_count_sql = "
    SELECT COUNT(*) AS total
    FROM branch_medicines
";

$availability_count_result =
    $crud->conn->query(
        $availability_count_sql
    );
...
if ($availability_count_result) {
    $row =
        $availability_count_result->fetch_assoc();
                        ...
                        >
                            ...
                            <div class="col-md-8">
                                ...
                                >
                                    ...
                                    Manage medicines, pharmacy
                                    branches, availability and
                            ...
                            >
                                ...
                                <a
                                    href="medicine_availability.php"
                                    class="btn btn-light"
                                >
            ...
            >
                ...
                <div class="card dash-widget">
                    ...
                    <div class="card-body">
                        ...
                        <span
                            class="dash-widget-icon bg-info"
                        >
            ...
            >
                ...
                <div class="card dash-widget">
                    ...
                    <div class="card-body">
                        ...
                        <span
                            class="dash-widget-icon bg-success"
                        >
                ...
                <div class="card">
                    ...
                    >
                        ...
                        <p class="text-muted">
                            ...
                            Quickly check which pharmacy
                            branch has the medicine available.
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="alert alert-warning">
                        ...
                        medicine availability record(s)
