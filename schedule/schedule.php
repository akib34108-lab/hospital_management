...
// Toggle Status er kaj - ei tuku notun
if(isset($_GET['toggle']) && isset($_GET['id'])){
    $id = $_GET['id'];
    $new_status = $_GET['toggle']; 

    $crud->common_update("schedules", ['status' => $new_status], ['id' => $id]);

    $_SESSION['message'] = array('success','Success', 'Status changed to '.$new_status);
							...
							<table class="table table-border table-striped custom-table mb-0">
								...
								<tbody>
									<tr>
                                        ...
                                        <td><?= $schedule->appointment_qty ?></td>
                                        <td>
                                            <!-- Status Badge -->
                                        ...
                                        <td class="text-center">
                                            <a href="<?= $base_url ?>schedule/edit_schedule.php?id=<?= $schedule->id ?>" class="btn btn-sm btn-primary mb-2 mb-lg-0 me-0 me-lg-2">Edit</a>
                                            <a onclick="return confirm('Are you sure you want to delete this schedule?');" href="<?= $base_url ?>schedule/delete_schedule.php?id=<?= $schedule->id ?>" class="btn btn-sm btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                            <?php } } ?>
								</tbody>
