...
<?php require_once "../component/sidebar.php"; 
  ...
  $id = $_GET['id'];
  $shift = $crud->common_select("shift", "*", ['id' => $id]);
  if (!$shift['status'] || empty($shift['data'])) {
    $_SESSION['message'] = array('danger','Error', 'Shift not found.');
    echo "<script>window.location.href = '".$base_url."shift/shift.php';</script>";
    exit;
  }
                        ...
                        <form action="<?= $base_url; ?>shift/update_shift.php?id=<?= $id ?>" method="POST" class="p-4">
                            ...
                            <div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="status" id="product_active" value="1" <?= $shift->status == 1 ? 'checked' : '' ?>>
									<label class="form-check-label" for="product_active">
									Active
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="status" id="product_inactive" value="0" <?= $shift->status == 0 ? 'checked' : '' ?>>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Update Shift</button>
                            </div>
                        </form>
                    </div>
                </div>
