                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-end">
                                            ...
                                            <a href="<?= $base_url ?>ward/discharge/discharge.php?admission_id=<?= $admission->id ?>" class="btn btn-sm btn-success mb-2 mb-lg-0 me-0 me-lg-2"><i class="fa fa-sign-out"></i> Discharge</a>
